...
description: 'The RTA protocol implements sophisticated delegation and proxy patterns to achieve flexible permissions, secure RTA/event dynamic updates, and modular architecture. The system combines minimal proxies, master implementations, and delegation registries for permission management.'
icon: 'sitemap-simple'
---
...
3. **Upgrade Risks**: UUPS proxies centralize upgrade authority, this will be decentralized through community governance on main net
4. **Storage Fragmentation**: Each proxy maintains separate storage context
5. **Global Whitelist Power**: Platform-wide permissions concentrate authority, this will be decentralized through community governance on main net
