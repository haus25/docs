...
description: 'The RTA protocol is deployed on Sei testnet. Here are the deployed contract addresses, and protocol TL;DRs.'
icon: 'globe'
---
...
**Chain ID:** `1328`  
**Block Explorer:** [SeiTrace](https://seitrace.com/?chain=atlantic-2)
