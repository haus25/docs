...
description: 'The RTA protocol is deployed on Sei testnet with a complete ecosystem of interconnected smart contracts. Here's the deployed contract addresses, and some protocol TL;DRs.'
icon: 'globe'
---
