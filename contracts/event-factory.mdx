---
title: 'EventFactory'
description: 'Central registry and NFT factory for RTA events. The EventFactory serves as the central hub of the RTA protocol, functioning as both an ERC721 NFT factory and the primary registry for all events. It manages event creation, per-event contract deployment, and serves as the single source of truth for event ownership and metadata.'
icon: 'industry'
---
