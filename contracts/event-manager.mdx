---
title: 'EventManager'
description: 'Permission management and delegation system for RTA events. The EventManager is an upgradeable contract that handles post-creation operations and permission management for RTA events. It acts as the sole authorized caller for EventFactory's restricted functions and implements a sophisticated delegation system using minimal proxy patterns.'
icon: 'user-gear'
---
