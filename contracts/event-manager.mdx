---
title: 'EventManager'
description: 'Permission management and delegation system for RTA events - EventManager is upgradeable and acts as the sole authorized caller for EventFactory's restricted post-minting functions.'
icon: 'user-gear'
---
