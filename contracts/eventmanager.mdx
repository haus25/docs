---
title: 'EventManager'
description: 'Permission management and delegation system for all RTA events. EventManager is upgradable and acts as the sole authorized caller for EventFactory's restricted post-minting functions and operations.'
icon: 'user-gear'
---
