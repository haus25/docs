...
**Planner Scope**:
- Token usage: ~3,700 tokens
- Estimated cost: $0.065
- Services: Event optimization, AI generation

**Promoter Scope**:
- Token usage: ~6,200 tokens  
- Estimated cost: $0.110
- Services: All Planner + promotional content

**Producer Scope**:
- Token usage: ~8,500 tokens (estimated)
- Estimated cost: $0.150 (estimated)
- Services: All Promoter + post-production
...
- **Producer Scope**: Architecture designed, implementation pending

## Selection Guidance

### Choose Planner if:
- First-time haus²⁵ creator exploring platform
- Focused on event content optimization
- Minimal promotional needs
- Budget-conscious approach

### Choose Promoter if:
- Established creator seeking audience growth
- Multi-platform promotional strategy needed
- Community building focus
- Professional promotional content required

### Choose Producer if:
- Premium post-production quality desired
- Professional documentation needed
- Complete end-to-end service preferred
- Maximum creator support wanted

## Related Documentation

- [Planner Scope](/curation/scopes/planner) - Detailed Planner agent capabilities
- [Promoter Scope](/curation/scopes/promoter) - Promotional strategy and execution
- [Producer Scope](/curation/scopes/producer) - Post-production and enhancement services
